...
public interface SimulationConstants {
     ...
     */
    public static record Offsets(Distance x, Distance y, Distance z, Angle roll, Angle pitch, Angle yaw) {
        ...
        public Pose3d applyToPose3d(Pose3d pose) {
            return new Pose3d(pose.getMeasureX().plus(x), pose.getMeasureY().plus(y), pose.getMeasureZ().plus(z), applyToRotation3d(pose.getRotation()));
        }
        ...
        public Pose3d applyToPose3dRobotRelative(Pose3d pose) {
            ...
            return new Pose3d(pose.getTranslation().plus(rotatedOffset), applyToRotation3d(pose.getRotation()));
        }
        ...
        public Rotation3d applyToRotation3d(Rotation3d rotation) {
            return new Rotation3d(rotation.getX() + roll.in(Radians), rotation.getY() + pitch.in(Radians), rotation.getZ() + yaw.in(Radians));
        }
        ...
        public Pose2d applyToPose2d(Pose2d pose) {
            return new Pose2d(pose.getMeasureX().plus(x), pose.getMeasureY().plus(y), applyToRotation2d(pose.getRotation()));
        }
        ...
        public Pose2d applyToPose2dRobotRelative(Pose2d pose) {
            ...
            return new Pose2d(pose.getTranslation().plus(rotatedOffset), applyToRotation2d(pose.getRotation()));
        }
    ...
    public interface Intake {
        ...
        public Offsets PIVOT_OFFSETS = new Offsets(0.2393388152, 0.0, // CAD zero angle offset degrees
        0.19685, Degrees.of(-40), Degrees.of(0), Degrees.of(90));
    ...
    public interface Drivetrain {
        ...
        public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration>[] MODULE_CONSTANTS = new SwerveModuleConstants[] { TunerConstants.FrontLeft, TunerConstants.FrontRight, TunerConstants.BackLeft, TunerConstants.BackRight };

        public static final Translation2d[] MODULE_TRANSLATIONS = new Translation2d[] { new Translation2d(MODULE_CONSTANTS[0].LocationX, MODULE_CONSTANTS[0].LocationY), new Translation2d(MODULE_CONSTANTS[1].LocationX, MODULE_CONSTANTS[1].LocationY), new Translation2d(MODULE_CONSTANTS[2].LocationX, MODULE_CONSTANTS[2].LocationY), new Translation2d(MODULE_CONSTANTS[3].LocationX, MODULE_CONSTANTS[3].LocationY) };
    }

    public static final Pose2d[] ROBOT_QUEENING_POSITIONS = new Pose2d[] { new Pose2d(-6, 0, new Rotation2d()), new Pose2d(-5, 0, new Rotation2d()), new Pose2d(-4, 0, new Rotation2d()), new Pose2d(-3, 0, new Rotation2d()), new Pose2d(-2, 0, new Rotation2d()) };

    public static final Pose2d[] ROBOTS_STARTING_POSITIONS = new Pose2d[] { // depot side trench facing hub
    new Pose2d(12.5, 0.5, Rotation2d.fromDegrees(90)), new Pose2d(12.5, 7.777, Rotation2d.fromDegrees(270)), new Pose2d(15, 2, Rotation2d.fromDegrees(180)), new Pose2d(1.6, 6, new Rotation2d()), new Pose2d(1.6, 4, new Rotation2d()) };
