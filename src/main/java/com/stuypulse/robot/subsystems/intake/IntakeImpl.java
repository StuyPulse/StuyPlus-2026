...
public class IntakeImpl extends Intake {
    ...
    public IntakeImpl() {
        ...
        // leader
        intakeRollerMotorLeft = new TalonFX(Ports.Intake.MOTOR_INTAKE_ROLLER_LEFT, Settings.CANBUS);
    ...
    private ControlRequest getPivotControl(IntakeState currentState) {
        ...
        return switch(currentState) {
            case INTAKE, OUTTAKE, DOWN ->
                pivotAboveThreshold ? pushdownController.withOutput(Settings.Intake.Pivot.PUSHDOWN_CURRENT.getAsDouble()) : pivotController.withPosition(currentState.getTargetAngle().getRotations());
            case HOMING_DOWN ->
                homingController;
            default ->
