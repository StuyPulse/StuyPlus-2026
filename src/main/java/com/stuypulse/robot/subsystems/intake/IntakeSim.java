...
public class IntakeSim extends Intake {
    ...
    public IntakeSim() {
        pivotSim = new SingleJointedArmSim(LinearSystemId.createDCMotorSystem(DCMotor.getKrakenX60(1), Settings.Intake.Pivot.J.in(KilogramSquareMeters), Settings.Intake.Pivot.GEAR_RATIO), DCMotor.getKrakenX60(1), Settings.Intake.Pivot.GEAR_RATIO, SimulationConstants.Intake.PIVOT_ARM_LENGTH, Settings.Intake.Pivot.MIN_ANGLE.getRadians(), Settings.Intake.Pivot.MAX_ANGLE.getRadians(), true, Settings.Intake.Pivot.INITIAL_ANGLE.getRadians());
