...
public class FeederVisualizer {
    private static FeederVisualizer instance;

    static {
        instance = new FeederVisualizer();
    }

    public static FeederVisualizer getInstance() {
        return instance;
    }
    ...
    public void update(double RPM) {
        SmartDashboard.putData("Visualizers/Feeder", canvas);
        ...
        SmartDashboard.putNumber("Feeder/visualizerRotation", rot);
    }
}