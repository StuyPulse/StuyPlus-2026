...
public class Cameras {
    ...
    public static final Camera[] LimelightCameras = new Camera[] { new Camera("limelight", new Pose3d(Units.inchesToMeters(-12.109), Units.inchesToMeters(-7.129), Units.inchesToMeters(8.375), // TODO: get actual camera info
